            ...
            <div className='md:w-[80%] w-full my-[20px] rounded-[12px] pt-[20px] pb-[30px] px-[5px] bg-primary border-[5px] border-secondary '>
                ...
                <div className='flex justify-center items-center flex-row flex-wrap w-full text-center mx-auto px-[5px]'>
                    <div className='md:w-[50%] w-full flex flex-col'>
                        <h1 className='font-bold text-[2.5rem] mt-[20px] mb-[10px]'>Track & Vote.Meet Pink Vote's Crypto App</h1>
                    ...
                    <div className='md:w-[50%] w-full flex flex-col items-center'>
                        <img src="https://coinvote.cc/template/images/coinvote_app.png" className='w-[75%]' alt="" />
                    </div>
                    <h1 className='font-medium text-[2.5rem] mt-[20px] mb-[10px]'>The Crypto World is in your hands.</h1>
                    
            <p className='md:text-[1.7rem] text-[1.2rem]  break-words'>Be early and find a project that hasn't been listed on major exchanges like CoinMarketCap, CoinGecko and others!</p>
                </div>
            </div>
        </div>
    )
